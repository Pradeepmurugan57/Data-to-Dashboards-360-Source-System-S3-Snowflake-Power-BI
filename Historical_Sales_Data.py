...
#generate the series of dates between 2015 and 2025 

random_dates = np.random.choice(np.arange(np.datetime64('2015-01-01'),np.datetime64('2025-08-28')),size = num_rows)
